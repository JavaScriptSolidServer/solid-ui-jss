...
import { renderAutoComplete, setVisible } from './autocompletePicker'; // dbpediaParameters
...
export async function renderAutocompleteControl(dom, person, barOptions, acOptions, addOneIdAndRefresh, deleteOne) {
    ...
    let decoratedAutocomplete = undefined;
